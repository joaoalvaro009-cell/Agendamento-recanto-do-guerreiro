...
export const Route = createFileRoute("/b/$slug/planos")({
  head: () => ({
    meta: [
  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <h1 className="mt-3 font-display text-4xl font-semibold tracking-tight sm:text-5xl">Planos mensais</h1>
      ...
      {loading ? (
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-3">
          {plans.map((p) => {
            ...
            return (
              <div key={p.id} className={`relative flex flex-col rounded-2xl border p-7 shadow-card transition ${
                p.featured
