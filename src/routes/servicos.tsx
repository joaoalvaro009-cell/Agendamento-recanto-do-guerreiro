      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {SERVICES.map((s) => (
            <div
              key={s.id}
              className="group relative overflow-hidden rounded-2xl border border-border/60 bg-surface/60 p-6 shadow-card transition hover:border-gold/60 hover:shadow-gold"
            >
