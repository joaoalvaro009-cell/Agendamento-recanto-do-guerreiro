...
export const Route = createFileRoute("/b/$slug/servicos")({
  head: () => ({
    meta: [
      { title: "Serviços e valores" },
      { name: "description", content: "Cortes, barba e cuidados premium. Confira preços e agende online." },
    ],
  }),
  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <h1 className="mt-3 font-display text-4xl font-semibold tracking-tight sm:text-5xl">Serviços & valores</h1>
        <p className="mt-4 text-muted-foreground">Cada detalhe pensado para entregar uma experiência impecável.</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((s) => (
            <div key={s.id} className="group relative overflow-hidden rounded-2xl border border-border/60 bg-surface/60 shadow-card transition hover:border-gold/60 hover:shadow-gold">
              {s.image_url && (
